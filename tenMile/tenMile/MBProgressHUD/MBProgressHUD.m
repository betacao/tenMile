...
//								constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:detailsLabel.font} context:nil].size;
